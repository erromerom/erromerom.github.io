...
Este libro incluye el resumen de las clases de principios de análisis químico, al igual que la ampliación de los ejercicios trabajados en clase.
...
::: \{.example name = ``Opción 1''\}
This is a \texttt{theorem} environment that can contain \textbf{any}
...
{\centering \includegraphics[width=0.8\linewidth]{PAQ_BOOK_files/figure-latex/nice-fig-1} 
